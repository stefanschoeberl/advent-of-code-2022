(module
    ...
    (global $signalSum (mut i32) (i32.const 0))
    ...
    (func $startCycle
        ...
        ;; if cycleNumber >= 20 && cycleNumber <= 220 && (cycleNumber - 20) % 40 == 0
        global.get $cycleNumber
        i32.const 20
        i32.ge_u
        ...
        i32.and
        if
            ;; signalSum = cycleNumber * registerX + signalSum
            global.get $cycleNumber
            global.get $registerX
            i32.mul
            global.get $signalSum
            i32.add
            global.set $signalSum
