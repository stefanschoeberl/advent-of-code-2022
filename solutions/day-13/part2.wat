(module
    ...
    (func $createDivider (param $n i32) (result i32)
        (local $listNode i32)
    ...
    (func $main
        ...
        ;; packet2 = createDivider(2)
        i32.const 2
        call $createDivider
        local.set $packet2

        ;; packet6 = createDivider(6)
        i32.const 6
        call $createDivider
        local.set $packet6
