(module
    ...
    (func $bfs (param $startX i32) (param $startY i32)
    ...
    (func $tryAllStartingPositions
        (local $x i32)
        (local $y i32)
        (local $bestNumSteps i32)

        ;; bestNumSteps = maxSteps
        global.get $maxSteps
        local.set $bestNumSteps
                ...
                block
                    loop
                        ...
                        if
                            ...
                            ;; if numberOfSteps[endX + endY * width] < bestNumSteps
                            global.get $numberOfSteps
                            global.get $endX
                            global.get $endY
                            global.get $width
                            ...
                            i32.add
                            i32.load
                            local.get $bestNumSteps
                            i32.lt_u
                            if
                                ;; bestNumSteps = numberOfSteps[endX + endY * width]
                                global.get $numberOfSteps
                                global.get $endX
                                global.get $endY
                                global.get $width
